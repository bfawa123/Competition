...
class LibrarianAgent:
    ...
    def run(self, user_input: UserInput, user_id: str) -> RecommendationResponse:
        ...
        # ========== 步骤4：生成自然语言推荐说明 ==========
        explanation = self._generate_explanation(top_books, memories)
    ...
    def _generate_explanation(self, books: List[BookScore], memories: List[Memory]) -> str:
        """生成自然语言推荐说明"""
        # 构建记忆引用文本
        memory_refs = []
        for mem in memories:
...
控制在150字以内。"""
        ...
        try:
            ...
            explanation = "根据您的需求和偏好，为您推荐以下书籍。"
