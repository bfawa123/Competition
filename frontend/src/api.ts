import { deleteMockMemory, getMockBooks, getMockMemories, makeRecommendation, mockTrace, writeMockMemory } from "./mockData";
import type { Book, Memory, RecommendationResponse, TraceStep, UserInput } from "./types";
