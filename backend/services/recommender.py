...
class Recommender:
    ...
    def _score_topic(self, book: Book, user_goal: str) -> float:
        ...
        # 中文主题关键词关联映射（跨主题弱匹配）
        goal_keywords = {
            "机器学习": ["深度学习", "人工智能", "算法", "数据结构", "Python基础", "统计"],
            "深度学习": ["机器学习", "人工智能", "算法", "神经网络"],
            "人工智能": ["机器学习", "深度学习", "算法"],
            "Python基础": ["算法", "数据结构", "机器学习", "软件工程"],
            "C/C++": ["算法", "数据结构", "操作系统", "嵌入式"],
            "Java": ["算法", "数据结构", "软件工程", "数据库"],
            "算法": ["数据结构", "Python基础", "C/C++", "Java", "离散数学"],
            "数据结构": ["算法", "Python基础", "C/C++", "Java"],
            "操作系统": ["数据结构", "算法", "计算机网络", "数据库"],
            "计算机网络": ["操作系统", "数据结构", "通信原理"],
            "数据库": ["数据结构", "算法", "软件工程"],
            "软件工程": ["数据库", "数据结构", "算法", "Python基础"],
        }

        keywords = goal_keywords.get(user_goal, [user_goal])
        book_text = f"{book.topic} {book.title} {book.description or ''} {' '.join(book.keywords)}".lower()
